...
if(isset($_POST["tambah"])) {
    ...
    if(!file_exists ($_FILES["gambarUpload"]["tmp_name"]) ) {
        ...
        $pesan_error = "gambar gagal diupload";
        return;
    } else {
        ...
        $sql = "INSERT INTO buku (gambar, judul, jumlah_halaman, pengarang, penerbit, tahun, jumlah_buku, jumlah_tersedia, jenis) 
        VALUES ('$nama_gambar_dan_ekstensi', '$judul', '$jumlah_halaman','$pengarang', '$penerbit', '$tahun', '$jumlah_buku', '$jumlah_buku', '$jenis')";
